...
> **Note**: If you change the syntax themes, delete the `static/syntax`
> directory to ensure that the new Syntect CSS files are properly updated.

{{ note(
header="Migration from Previous Versions"
body='
